__d(function(g,r,i,a,m,e,d){"use strict";Object.defineProperty(e,'__esModule',{value:!0});var t=r(d[0]);Object.keys(t).forEach(function(n){'default'===n||Object.prototype.hasOwnProperty.call(e,n)||Object.defineProperty(e,n,{enumerable:!0,get:function(){return t[n]}})})},1430,[1435]);
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */const Pe='app-check-internal';(0,e._registerComponent)(new t.Component("app-check",e=>ie(e.getProvider('app').getImmediate(),e.getProvider('heartbeat')),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,n)=>{e.getProvider(Pe).initialize()})),(0,e._registerComponent)(new t.Component(Pe,e=>ae(e.getProvider('app-check').getImmediate()),"PUBLIC").setInstantiationMode("EXPLICIT")),(0,e.registerVersion)("@firebase/app-check","0.13.0")},1435,[712,713,714,716]);